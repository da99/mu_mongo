...
# Originall found at: 
# http://rethink.unspace.ca/2009/1/3/protect-your-rails-app-from-malicious-xss-attacks
...
#  Sanitize.html() is a case-insensitive sanitizer suitable for HTML
...
#    Sanitize.html( string, {:encoding => 'iso-8859-1', :to_tree => true} ) ->  REXML::Document
#
# Unless otherwise specified, the string is assumed to be utf-8 encoded.
# By default, the output is a string. But, optionally, you can return a REXML tree.
#
